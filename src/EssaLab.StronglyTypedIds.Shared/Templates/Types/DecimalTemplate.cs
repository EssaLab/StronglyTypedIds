...
//           """;
    ...
    public string GenerateCoreCode(string name, string ns, bool isValueType)
    {
        ...
        return $$"""
                ...
                /// </summary>
                #if NET7_0_OR_GREATER
                public partial {{recordType}} {{name}}(decimal Value) : IComparable<{{name}}>, IEquatable<{{name}}>, IParsable<{{name}}>
                #else
                public partial {{recordType}} {{name}}(decimal Value) : IComparable<{{name}}>, IEquatable<{{name}}>
                #endif
                {
                    public static {{name}} Empty => new(0m);
